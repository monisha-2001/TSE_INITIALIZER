...
public class ProjectStructureGenerator {
    ...
    public static void createProjectStructure(File rootDirectory, Detail details) {
      ...
      //File creation
        ...
        //controller class
         File ControllerFile = new File(srcMainJava,"HelloWorldController.java");
        createControllerFile(ControllerFile,details);
        ...
        // Create a sample application.properties (you can generate it based on userinput)
        ...
        try {
            ...
            // Add or update the server.port property
            FileWriter writer = new FileWriter(applProp, true); // true for appending
            writer.write("server.port=9090"); // Replace 8080 with your desired port
            writer.close();

            System.out.println("server.port property added to application.properties");
        } catch (IOException e) {
    ...
    //Controller file
    private static void createControllerFile(File javaFile,Detail details) {
        ...
        String javaCode = "package " + details.getGroupId() + "." + details.getArtifactId() + ";\n\n" +
                            ...
                            "public class HelloWorldController {\n"+
                                ...
                                "public String helloWorld() {\n"+
                                    "\treturn \"Welcome to TSE Initializer, Created by Team 3\";\n"+
                                "}\n"+
                            "}";
    ...
    //when we select war,this file is created
 ...
 // craete a java test file
    ...
    // pom.xml maven file
    private static void createMavenPomXml(File pomXml, Detail details) {
    ...
    private static void createGradlePomXml(File buildGradleKtsFile, Detail details) {
        String formattedDependencies = formatDependencies(details.getDependencies());
